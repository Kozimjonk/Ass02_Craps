        ...
        do {
            ...
            switch (roll)
            {
                case 2: case 3: case 12:
                    ...
                    break;
                case 7: case 11:
                    System.out.println("You rolled " + roll + ". You got a natural and won!");
                    break;
                default:
                    point = roll;
                    ...
                    do {
                        ...
                        {
                            System.out.println("You rolled " + roll + ". The point was " + point + ". You won!");
                            reroll = false;

                        }
                        else
                        {
                            System.out.println("You rolled " + roll + ". Try Again!");
                            reroll = true;
                        }
